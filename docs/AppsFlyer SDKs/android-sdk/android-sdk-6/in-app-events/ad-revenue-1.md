...
- In the app global class, inside the `onCreate` method, call [`initialize`](doc:appsflyeradrevenue#initaliaze), and put the following code:
...
- Trigger the [`logAdRevenue`](doc:appsflyeradrevenue#logadrevenue) API call upon every valid impression, including mandatory, and any optional, arguments.
