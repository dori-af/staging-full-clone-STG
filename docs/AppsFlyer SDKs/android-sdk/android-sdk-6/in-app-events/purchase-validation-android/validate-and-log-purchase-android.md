...
The `validateAndLogInAppPurchase` method is part of [the receipt validation flow](https://support.appsflyer.com/hc/en-us/articles/42136725767569--WIP-About-Receipt-validation#how-does-receipt-validation-work), which enables your app to validate in-app purchase events generated by Google Play.
...
- [validateAndLogInAppPurchase](#implement-validateandloginapppurchase-beta) supported from SDK v.6.17.5
